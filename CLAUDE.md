...
- خطوط: IBM Plex Arabic + Inter + Playfair Display
...
| الموقع | الغرض |
|---|---|
| `D:\نيابة\وفاء للحج\` | مجلد الوثائق والمستندات (Briefs، MD files) |
| `D:\نيابة\وفاء للحج\site\` | نسخة العمل العربية (للمراجعة المحلية) |
| `C:\Users\mubar\wafahajj\` | **نسخة Git الرئيسية** — متصلة بـ GitHub |
| `https://github.com/abuown77/wafahajj` | المستودع العام |

**تنبيه**: Git على Windows لا يدعم المسارات العربية. نعمل على `C:\Users\mubar\wafahajj\` وننسخ التحديثات للمجلد العربي عند الحاجة.
...
- [x] اختيار مسار العمل: `D:\نيابة\وفاء للحج\site\`
